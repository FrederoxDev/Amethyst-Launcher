  ...
  return (
    <AppStateProvider>
      ...
      <div className="container relative">
        ...
        <div
          className={`contents_container absolute flex flex-row w-full gap-[12px] h-[calc(100%-64px)] p-[12px] ${location.pathname !== '/' ? 'backdrop-blur-[4px]' : ''} transition-[backdrop-filter] duration-[300ms]`}
        >
