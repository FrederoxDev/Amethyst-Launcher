...
import { VersionsFolder } from "@renderer/scripts/Paths";
...
export function GetPackagePath() {
    return null// GetPackage()?.values["PackageRootFolder"].value as string;
}

export function GetPackageID() {
    return null// GetPackage()?.values["PackageID"].value as string;
}
