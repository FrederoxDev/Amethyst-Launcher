...
import { GetPackagePath } from "@renderer/scripts/AppRegistry";
...
import { DeletePath, ElectronAppPath, ValidatePath, VersionsFile, VersionsFolder } from "@renderer/scripts/Paths";
import { MinecraftVersion, VersionsFileObject } from "@renderer/scripts/Versions";
