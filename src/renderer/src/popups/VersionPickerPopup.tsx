...
export function VersionPickerPopup({ submit: rawSubmit, restrictToChannel }: Props) {
    ...
    useEffect(() => {
        versions.catalog.refresh()
            ...
            .catch(e => {
                log("VersionPicker", `Could not load the version list, showing installed versions only: ${describeError(e)}`);
                    ...
                    {visibleInstalled.map(v => (
                        ...
                        >
                            ...
                            <div className="version-picker-item-actions">
                                ...
                                <div className="version-picker-item-btn" onClick={e => {
                                    e.stopPropagation();
                                    shell.openPath(v.path).then(error => log(
                                        "VersionPicker",
