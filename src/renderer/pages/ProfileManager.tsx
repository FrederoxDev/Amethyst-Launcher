...
export default function ProfileManager() {
  ...
  const ProfileButton = useCallback((profile: Profile, index: number) => {
    ...
    return (
      <div onClick={() => OpenProfile(index)} className="cursor-pointer border-[3px] border-[#1E1E1F] m-[-3px]" key={index}>
            ...
            <div className="flex flex-col w-full gap-[3px] border-[3px] border-[#1E1E1F] bg-[#313233]">
              {
                profiles.length > 0 ?
                  ...
                  <div className="flex flex-col gap-[4px] flex-grow h-[58px] justify-center items-center">
                    ...
                    <p className="minecraft-seven text-[14px] text-[#B1B2B5]">Create a new profile by clicking "Create
                      New Profile" below</p>
                  </div>
              }
            </div>
