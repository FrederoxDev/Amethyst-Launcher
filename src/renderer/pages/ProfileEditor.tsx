            ...
            <div className="flex flex-row h-full border-y-[3px] border-y-[#1E1E1F] bg-[#48494a] overflow-hidden">
              {
                profile_runtime !== undefined && (
                  sub_page === 'Mods' ?
                    ...
                    :
                    <div className="flex justify-center p-[12px] inset_button cursor-pointer"
                    ...
                    <div className="flex flex-col w-full gap-[3px] border-[3px] border-[#1E1E1F] bg-[#313233]">
                      {
                        active_mods.length > 0 ?
                          ...
                          <div className="flex flex-col gap-[4px] flex-grow h-[58px] justify-center items-center">
                            ...
                            <p className="minecraft-seven text-[14px] text-[#B1B2B5]">Activate a mod by clicking on it in
                              the "Inactive Mods" list</p>
                          </div>
                      }
                    </div>
                  </div>
