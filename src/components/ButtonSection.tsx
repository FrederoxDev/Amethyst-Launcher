...
export default function ButtonSection({launchGame, actionLock, loadingPercent, status}: ButtonSectionProps) {
    ...
    return (
        <div className="absolute bottom-0 w-full">
            <div
                className={`bg-[#313233] ${actionLock ? "h-[25px]" : "h-[0px]"} transition-all duration-300 ease-in-out`}>
            ...
            <DividedSection>
                <div className="flex justify-around">
                    <div className="w-[45%]">
                        <MinecraftButton text='Launch Game' onClick={launchGame} key='launch-game'
                                         disabled={actionLock}/>
                    </div>
                    <div className="w-[45%]">
