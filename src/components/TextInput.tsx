    ...
    return (
        <>
            ...
            <div className="border-[3px] h-[25px] border-[#1E1E1F] bg-[#313233]">
                <input type="text" className="w-full minecraft-seven outline-none bg-transparent translate-y-[1px] pl-[4px] text-white text-[12px]" spellCheck={false} value={text} onInput={(event) => {
