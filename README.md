...
> [!IMPORTANT]
> Amethyst Launcher won't work if you do not own Minecraft Bedrock Edition, or if your install path is not default path.(C:\Users\<your-user-name>\AppData\Local\Programs\Amethyst-Launcher)
